...
ggplot(earnings_by_role, aes(x = Role, y = AverageEarnings, fill = Role)) +
  geom_col(show.legend = FALSE) +
  labs(title = "Gains moyens par rôle parmi les 100 meilleurs joueurs", x = "Rôle", y = "Gains moyens (USD)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
```{r}
